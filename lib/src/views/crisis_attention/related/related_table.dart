...
class CrisisAttentionRelatedTableWidget extends StatefulWidget {
  final int formId;

  const CrisisAttentionRelatedTableWidget({Key? key,required this.formId}) : super(key: key);
  @override
  _CrisisAttentionRelatedTableWidgetState createState() => _CrisisAttentionRelatedTableWidgetState();
}

class _CrisisAttentionRelatedTableWidgetState extends State<CrisisAttentionRelatedTableWidget> {
  ...
  Future<void> _getRelatedForms() async {
    ...
    this._relatedForms = await CrisisAttentionService().getRelatedForms(formId: widget.formId) ?? [];
  ...
  Future<void> _removeRelatedForm(int childId) async {
    ...
    AwesomeDialog(
        ...
        btnOkOnPress: () async {
          ...
          bool removed = await CrisisAttentionService().removeRelatedForm(fatherId: widget.formId, childId: childId);
