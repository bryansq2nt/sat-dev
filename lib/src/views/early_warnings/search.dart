...
class SearchEarlyWarningView extends StatefulWidget {
  @override
  _SearchEarlyWarningViewState createState() => _SearchEarlyWarningViewState();
}

class _SearchEarlyWarningViewState extends State<SearchEarlyWarningView> {
  ...
  Future<List<FormModel>> _searchForm(String text) async {
    ...
    List<FormModel>? forms =  await EarlyWarningsService().searchForms(delegate: text);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //     placeHolder: Center(child: Text("Buscar Alerta", style: TextStyle(color: Color(0xff1f0757),fontWeight: FontWeight.bold),),),
      //     //cancellationText: ,
          ...
          Container(
            ...
            child: Container(
                ...
                child: IconButton(
                  ...
                  onPressed: (){
                    if(!form.analyzed){
                      Navigator.pushNamed(context, '/modifyEarlyWarning',arguments: form);
                    } else {
                      AwesomeDialog(
                          isDense: true,
                          context: context,
                          ...
                          title: "SAT PDDH",
                          desc: "Lo sentimos la alerta ya ha sido analizada.",
                          btnOkOnPress: () {},
