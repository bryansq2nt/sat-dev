...
class AnalyzeEarlyWarningView extends StatefulWidget {
  ...
  const AnalyzeEarlyWarningView({Key? key, required this.formId})
      : super(key: key);
  @override
  _AnalyzeEarlyWarningViewState createState() =>
      _AnalyzeEarlyWarningViewState();
}
...
class _AnalyzeEarlyWarningViewState extends State<AnalyzeEarlyWarningView> {
  ...
  errorAnalysingAlert() {
    AwesomeDialog(
        ...
        title: "SAT PDDH",
        desc:
            "Lo sentimos ha ocurrido un error al intentar analizar la alerta.",
        btnOkOnPress: () {},
        btnOkColor: Color(0xFFF2B10F))
      ..show();
  }
  ...
  void _analyzeAlert() async {
    if (_validate() && !analyzing) {
      ...
      bool analyzed = await EarlyWarningsService()
