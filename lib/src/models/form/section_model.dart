...
SectionModel dependentSectionModelFromJson(String str) => SectionModel.fromJson(json.decode(str));
...
class SectionModel extends Dependent{
  SectionModel(
      ...
      }) : super(sectionId,dependentSectionId, dependentMultiple, sectionDependentAnswer, sectionDependentQuestions, );
  ...
  factory SectionModel.fromJson(Map<String, dynamic> json){
    ...
    List<dynamic> questions = QuestionsUtilities().getQuestions(json);
   ...
   bool getBool(var val){
    ...
    return SectionModel(
      ...
      sectionDependentAnswer: json['dependent_answer'] != null ? DependentAnswerModel.fromJson(json['dependent_answer']) : null,
